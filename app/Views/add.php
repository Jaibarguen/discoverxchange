...
<div class="col-lg-4 col-6 text-right">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="<?php echo base_url().'detail'; ?>" class="nav-item nav-link">Detalles de productos</a>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-dark" href="<?php echo base_url().'nueva-venta'; ?>">Crea tu producto</a>
                    <span class="breadcrumb-item active">Añade tu producto</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid pb-5">
        ...
        <div class="col-lg-5 mb-30">
                ...
                <div class="contact-form bg-light p-30">
                        ...
                        <h5 class="mb-3"><?php echo $_SESSION['producto'] ?></h5>
                        </div>
                        <div class="control-group">
                        <div class="form-floating mb-3">
                        <strong class="text-dark mr-3">Tipo de producto: <?php echo $_SESSION['tipo'] ?></strong>
                        </div>
                        </div>
                        <div class="form-floating mb-3">
                        <h4 class="mb-3">Precio del producto</h4>
                        <h5 class="mb-3">$ <?php echo $_SESSION['precio'] ?></h5>
                        </div>
                </div>
                <form id="form" action="<?php echo base_url().'nuevo-producto'; ?>" method="post">
                    <div class="control-group">
                        <h4 class="mb-3">Foto</h4>
                            <input type="file" class="form-control" id="name" placeholder="Seleccionar imagen" name="im"
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                        ...
                        <h4 class="mb-3">Informacion</h4>
                            <textarea class="form-control" rows="8" id="message" placeholder="Informacion del producto" name="in"
                                required="required"
                                data-validation-required-message="Por favor ingresa la informacion del producto"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        <h4 class="mb-3">Descripcion detallada</h4>
                            <textarea class="form-control" rows="8" id="message" placeholder="Descripcion del producto" name="de"
                                required="required"
                                data-validation-required-message="Por favor ingresa la informacion del producto"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        <h4 class="mb-3">Cantidad de productos</h4>
                            <input type="number" class="form-control" id="floatingText" placeholder="Cantidad de productos" name="ca"
                            required="required" data-validation-required-message="Por favor ingresa la informacion del producto">
                            <p class="help-block text-danger"></p>
                            <?php if(session('stock')):?>
                        <h8 class="text-danger">El limite maximo son 100 productos.</h8>
                        <?php endif;?>
                        </div>
                    
                    <div class="d-flex align-items-center mb-4 pt-2">
                        
                        <button class="btn btn-primary px-3">+ Añade tu producto</button>
                    </div>
                        </form>
                </div>
            </div>
    ...
    <h1>NO PUEDE REALIZAR VENTAS SIN ELEGIR EL TIPO DEL PRODUCTO QUE VA A VENDER</h1>
    <?php endif;?>
