        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="<?php echo base_url().'soporte'; ?>" class="nav-item nav-link active">Contactos</a>
                    </div>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Soporte</span>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    <div id="success"></div>
                    <form action="<?php echo base_url().'enviar'; ?>" enctype="multipart/form-data" method="post">
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" placeholder="Nombre" name="No"
                                required="required" data-validation-required-message="Por favor ingresa tu nombre">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="email" class="form-control" id="email" placeholder="Email" name="Em"
                                required="required" data-validation-required-message="Por favor ingresa tu email">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="Problema" name="Pr"
                                required="required" data-validation-required-message="Por favor ingresa tu problema">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea class="form-control" rows="8" id="message" placeholder="Descripcion del problema" name="De"
                                required="required"
            ...
            <div class="col-lg-5 mb-5">
                <div class="bg-light p-30 mb-30">
                    ...
                    src="https://www.google.com/maps/d/embed?mid=14Z9gvUFA29NWoxbwzGl2b9kIK-s&msa=0&ie=UTF8&t=p&ll=6.315299000000014%2C-76.72851599999998&spn=4.91236%2C6.031494&z=7&output=embed"
                ...
                <div class="bg-light p-30 mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+57 321 4482182</p>
                </div>
            </div>
        </div>
    </div>
